...
public class lotto649_MySQL2 {
		...
		public lotto649_MySQL2(String ar[],String Year){
			useLotto = ar;
			this.Year = Year;
		}
...
//	        TreeMap<String,String> ansData = new TreeMap<>();
	        ...
	        System.out.println(lottoData.get("獎號"));
			//每一期比對都會從這開始 (forEach)
			...
			ansLotto = value.split(",");//裝入 由資料庫取得的獎號
			for(String s:ansLotto) {
...
//			System.out.println("中獎 - 總數: "+bonusAll);
	    ...
	    public static void main(String[] args) {
			String nar[] = {"7","30","32","44","48","8"};
			lotto649_MySQL2 a1 = new lotto649_MySQL2(nar,"2019");
